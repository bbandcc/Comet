...
- store       审计落库 / 历史查询(SQLAlchemy)
- rubric/     评分维度定义(基类 + research / task)
- verifier/   独立 LLM-as-judge(基类 + 同模型 self-critique + 独立配置 critic)
...
3. State ⊥ Process      loop_runs/loop_iterations 提供 audit trail,为后续 S4 恢复能力打基础
"""
